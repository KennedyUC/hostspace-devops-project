                        ...
                        <div className='col-8'>
                                <div class="h-100 p-5 text-bg-dark jumb1">
                                    <div className='text-end'><GraphicEqIcon/></div>
                                        ...
                                        <p><span className='fw-bold'>{pictdata["date_of_birth"]}</span> and I am from <span className='fw-bold'>{pictdata["department"]}</span> department and i am happy to join STL family</p>
